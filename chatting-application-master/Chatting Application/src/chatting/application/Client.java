...
public class Client implements ActionListener {
    ...
    Client() {
        ...
        // Click on profile to open profile window
        ...
        // Video and phone buttons (no changes here)
    ...
    private void openProfileWindow() {
        ...
        profileFrame.setLocation(800, 200);

        // Profile Picture
        JLabel profilePic = new JLabel(new ImageIcon(ClassLoader.getSystemResource("icons/2.png")));
        ...
        JLabel userName = new JLabel("Username: Bunty");
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while(true) {
                ...
                f.validate();  // Revalidate after adding a new message
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
